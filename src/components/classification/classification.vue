    ...
    >
      ...
      <div slot="content" >
        <div class="commodityLMX">
          ...
          <van-grid :gutter="10" v-if="items[activeIndex]">
            <van-grid-item v-for="value in items[activeIndex].children" :key="value.id"  text="文子"  @click="DPTZ" >
              <img src="//img10.360buyimg.com/mobilecms/s200x200_jfs/t1/45183/34/14007/70781/5dad62b4e1954d8ab/426f84dd2099e7be.jpg!q70.dpg.webp " alt="">
            <p>{{value.text}}</p>
            </van-grid-item>
          </van-grid>
        </div>
